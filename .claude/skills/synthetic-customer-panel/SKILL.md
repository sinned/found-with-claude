...
2. **Customer context** (use one of these sources):
   - Output from `/customer-discovery-synthesizer` in `examples/customer-synthesis-output.md`
   - A description of the target customer in the current conversation
   - `examples/founder-context.md`
...
9. **Save output** — Write to `examples/synthetic-customer-panel-output.md`.
