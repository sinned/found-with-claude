...
Put raw data in `work/pmf-signal-review/` or share it in the current conversation.
...
9. **Save output** — Write to `work/pmf-signal-review/pmf-signal-review-output.md`.
