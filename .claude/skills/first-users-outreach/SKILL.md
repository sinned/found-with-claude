...
Look for:
- `work/[startup]/product-strategy-brief/product-brief-output.md` — who the target customer is
- `work/[startup]/prototype-scope/prototype-scope-output.md` — what the prototype does
- `work/[startup]/customer-discovery-synthesizer/customer-synthesis-output.md` — specific people or companies mentioned in discovery
...
7. **Save output** — Write to `work/[startup]/first-users-outreach/first-users-outreach-output.md`.
