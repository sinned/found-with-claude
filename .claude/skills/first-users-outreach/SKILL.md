...
Look for:
- `work/[startup]/product/strategy-brief.md` — who the target customer is
- `work/[startup]/product/prototype-scope.md` — what the prototype does
- `work/[startup]/customers/synthesis.md` — specific people or companies mentioned in discovery
...
7. **Save output** — Write to `work/[startup]/traction/outreach-plan.md`.
