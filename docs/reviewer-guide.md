...
- `work/[startup]/founder-opportunity-map/founder-context.md` — sample founder context
- `work/[startup]/customer-discovery-synthesizer/customer-transcript-1.md` — sample interview transcript
- `work/[startup]/founder-opportunity-map/opportunity-memo-output.md` — sample skill output
...
```
Input: anything in `work/[startup]/founder-opportunity-map/founder-context.md`. Expected: structured opportunity memo.

```
/customer-discovery-synthesizer
```
Input: `work/[startup]/customer-discovery-synthesizer/customer-transcript-1.md`. Expected: synthesis with patterns and quotes.
