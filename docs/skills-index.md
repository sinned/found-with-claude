...
**Key outputs:**
- `work/[startup]/founder-opportunity-map/opportunity-memo-output.md`
...
**Key outputs:**
- `work/[startup]/customer-discovery-synthesizer/customer-synthesis-output.md`
...
**Key outputs:**
- `work/[startup]/synthetic-customer-panel/synthetic-customer-panel-output.md`
...
**Key outputs:**
- `work/[startup]/product-strategy-brief/product-brief-output.md`
...
**Key outputs:**
- `work/[startup]/prototype-scope/prototype-scope-output.md`
...
**Key outputs:**
- `work/[startup]/prototype-review/prototype-review-output.md`
...
**Key outputs:**
- `work/[startup]/first-users-outreach/first-users-outreach-output.md`
...
**Key outputs:**
- `work/[startup]/pmf-signal-review/pmf-signal-review-output.md`
...
**Key outputs:**
- `work/[startup]/growth-experiment-backlog/growth-experiment-backlog-output.md`
...
**Key outputs:**
- `work/[startup]/founder-hiring-scorecard/hiring-scorecard-[role].md`
...
**Key outputs:**
- `work/[startup]/fundraising-narrative/fundraising-narrative-output.md`
...
**Key outputs:**
- `work/[startup]/demo-day-script/demo-day-script-output.md`
...
**Key outputs:**
- `work/[startup]/weekly-founder-review/weekly-review-[date].md`
